...
void cal_vfrac()
{
double vfrac,cavg,vfrac1,vfrac2,vfrac3,vfrac4,vfrac5;
...
vfrac=0;cavg=0;vfrac1=0;vfrac2=0;vfrac3=0;vfrac4=0;vfrac5=0;
...
for_xijk
	...
	vfrac1+=eta_r[0][x_i][x_j][x_k];
	vfrac2+=eta_r[1][x_i][x_j][x_k];
	vfrac3+=eta_r[2][x_i][x_j][x_k];
	vfrac4+=eta_r[3][x_i][x_j][x_k];
	vfrac5+=eta_r[4][x_i][x_j][x_k];
	cavg+=cr[xijk];
efor_xijk
vfrac/=L*M*N;
vfrac1/=L*M*N;
...
vfrac5/=L*M*N;
cavg/=L*M*N;
printf("vf = %7.6lf ,v1=%7.6lf, v2=%7.6lf, v3=%7.6lf, v4=%7.6lf, v5=%7.6lf,  c_avg = %7.6lf\n",vfrac, vfrac1, vfrac2, vfrac3, vfrac4, vfrac5,cavg);
}//end of cal_vfrac()
